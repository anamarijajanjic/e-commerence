...
E-naruči - aplikacija koja omogućuje korisniku registraciju, odabir ponuđenih artikala(spremanje u košaricu) i "kupovinu" istih. 
Ulaskom u artikl vidljivi su cijena, opis i njegovo stanje u e-trgovini.
Nakon dodovanja artikla u košaricu, korisnik može nastaviti dodavanje ostalih artikala ili kupiti već dodane.
Kako bi završio kupovinu, korisnik se mora registrirati, odnosno prijaviti.

## Tehnologije
1. Frontend: React i Redux
2. Backend: Node i Express 
3. Baza: MongoDB

## Popis funkcionalnosti
1. Registracija i prijava
2. Filtriranje artikala pomoću određenih parametara
3. Dodavanje artikala u košaricu
4. "Kupovina" artikala
5. Odlogiranje
